          ...
          <div className="flex items-center gap-3 pb-1">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                Darcy Murphy's Public KnowledgeBot
              </h1>
              {isInitialized && (
          ...
          {!isInitialized ? (
            ...
            <div className="text-center py-16">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-3">
                Welcome to Darcy Murphy's Public KnowledgeBot
              </h2>
              <p className="text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
                This assistant is based on Darcy Murphy's public content.
                Responses are for informational purposes only and may not be
                100% accurate. All intellectual property belongs to Darcy Murphy.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto mb-8">
                ...
                <div className="text-center p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Compassionate dentist promoting oral health through modern technology, preventive care, and patient-centered education.
                  </p>
                </div>
                ...
                <div className="text-center p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Get specific video guidance from Darcy's content library
                  </p>
                </div>
              </div>
            </div>
